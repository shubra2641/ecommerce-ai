...
/**
 * RegisterRequest handles validation for user registration
 * 
 * This request validates user registration data including name, email,
 * and password with security measures and confirmation.
 */
