...
/**
 * MessageUpdateRequest handles validation for message updates
 * 
 * This request validates message update data including name, email,
 * subject, message content, phone, and status with security measures.
 */
