...
/**
 * CouponStoreRequest handles validation for coupon creation
 * 
 * This request validates coupon creation data including code, type,
...
class CouponStoreRequest extends FormRequest
{
    ...
    {
        return [
            'code' => 'required|string|max:50|min:3|unique:coupons,code|regex:/^[A-Z0-9\-_]+$/',
