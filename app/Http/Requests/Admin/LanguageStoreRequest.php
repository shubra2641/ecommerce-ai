...
/**
 * LanguageStoreRequest handles validation for language creation
 * 
 * This request validates language creation data including code, name,
...
class LanguageStoreRequest extends FormRequest
{
    ...
    {
        return [
            'code' => 'required|string|max:10|min:2|unique:languages,code|regex:/^[a-z]{2}(-[A-Z]{2})?$/',
