...
/**
 * PostUpdateRequest handles validation for post updates
 * 
 * This request validates post update data including title, content,
...
class PostUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'title' => 'required|string|max:255|min:5|unique:posts,title,' . $postId,
