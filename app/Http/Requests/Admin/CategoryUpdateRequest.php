...
/**
 * CategoryUpdateRequest handles validation for category updates
 * 
 * This request validates category update data including title, summary,
...
class CategoryUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'title' => 'required|string|max:255|min:2|unique:categories,title,' . $categoryId,
