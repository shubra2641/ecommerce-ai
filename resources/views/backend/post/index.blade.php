...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">{{ trans('app.all_posts') }}</h6>
      <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="{{ trans('app.add_post') }}"><i class="fas fa-plus"></i> {{ trans('app.add_post') }}</a>
    </div>
    <div class="card-body">
        ...
        <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th>{{ trans('app.post_category') }}</th>
              <th>{{ trans('app.post_tag') }}</th>
          ...
          <tbody>
            ...
            @foreach($posts as $post)
                <tr>
                    ...
                    <td>{{$post->author_info->name ?? 'N/A'}}</td>
                    <td>
                        @if($post->photo)
