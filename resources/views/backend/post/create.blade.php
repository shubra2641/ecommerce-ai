...
<div class="card">
    <h5 class="card-header">{{ trans('app.add_post') }}</h5>
    <div class="card-body">
              ...
              <div class="tab-pane fade {{ $i==0 ? 'show active' : '' }}" id="pane-{{ $lang->code }}">
                @if($lang->code == ($defaultLang->code ?? null))
                  <div class="form-group">
                    ...
                    <textarea class="form-control lang-summary" id="quote" name="quote">{{old('quote')}}</textarea>
                    @error('quote')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                  </div>
                ...
                @else
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control lang-summary" name="translations[{{ $lang->code }}][quote]" data-lang="{{ $lang->code }}">{{ old('translations.'.$lang->code.'.quote') }}</textarea>
                  </div>
                  <div class="form-group">
