...
@section('title', trans('app.banner_management'))
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">{{ trans('app.all_banners') }}</h6>
      <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="{{ trans('app.add_banner') }}"><i class="fas fa-plus"></i> {{ trans('app.add_banner') }}</a>
    </div>
    <div class="card-body">
        ...
        <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th>{{ trans('app.banner_title') }}</th>
              <th>{{ trans('app.slug') }}</th>
              <th>{{ trans('app.banner_photo') }}</th>
              <th>{{ trans('app.banner_status') }}</th>
