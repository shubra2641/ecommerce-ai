...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">{{ trans('app.all_post_categories') }}</h6>
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="{{ trans('app.add_post_category') }}"><i class="fas fa-plus"></i> {{ trans('app.add_post_category') }}</a>
    </div>
    <div class="card-body">
