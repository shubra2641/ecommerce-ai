...
@section('main-content')
					...
					<div class="col-12">
						<div class="bread-inner">
                                <ul class="bread-list">
                                	...
                                	<li class="active"><a href="javascript:void(0);">{{ __('frontend.home.latest_items') }}</a></li>
                                </ul>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
										...
										<div class="price-filter-inner">
											{{-- <div id="slider-range" data-min="10" data-max="2000" data-currency="%"></div>
												...
												<div class="label-input">
													<span>Range:</span>
													<input type="text" id="amount" name="price_range" value='{{ request()->query("price") ?? "" }}' placeholder="Add Your Price"/>
												</div>
											</div> --}}
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if($products && (is_array($products) || is_countable($products)) && count($products))
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<p class="des pt-2">{!! safe_html(html_entity_decode($product->summary)) !!}</p>
														<a href="{{ route('add-to-cart', $product->slug) }}" class="btn cart" data-id="{{$product->id}}">{{ __('frontend.buttons.add_to_cart') }}</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="quickview-content">
												...
												<div class="quickview-ratting-review">
													...
													<div class="quickview-stock">
														@if($product->stock >0)
														<span><i class="fa fa-check-circle-o"></i> {{$product->stock}} {{ __('frontend.product.in_stock') }}</span>
														@else 
														<span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} {{ __('frontend.labels.out_of_stock') }}</span>
														@endif
													</div>
												</div>
		...
		@endif
			<!-- Modal end -->
@endsection
{{-- Page-specific styles moved to `public/frontend/css/style.css` per project rules. --}}
{{-- Page-specific scripts moved to `public/frontend/js/variant-switcher.js` and centralized layout imports. --}}