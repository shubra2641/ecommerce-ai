                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">{{ __('frontend.blog.single_title') }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="content">
                                        @if($post->quote)
                                        <blockquote> <i class="fa fa-quote-left"></i> {!! safe_html($post->quote) !!}</blockquote>
                                        @endif
                                        <p>{!! safe_html($post->description) !!}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="content-tags">
                                                <h4>{{ __('frontend.blog.tags_label') }}</h4>
                                                <ul class="tag-inner">
                                                    @foreach($tags as $tag)
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                        ...
                                        <h2 class="reply-title">{{ __('frontend.blog.leave_comment') }}</h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group  comment_form_body">
                                                        <label>{{ __('frontend.blog.your_message') }}<span>*</span></label>
                            ...
                            @else
                                ...
                                {!! __('frontend.blog.login_or_register_for_comment', ['login' => route('login.form'), 'register' => route('register.form')]) !!}
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">{{ __('frontend.blog.comments_title', ['count' => $post->allComments->count()]) }}</h3>
                                    <!-- Single Comment -->
                        ...
                        <div class="single-widget side-tags">
                            ...
                            <ul class="tag">
                                @foreach(Helper::postTagList('posts') as $tag)
                                    <li><a href="{{route('blog.tag', $tag->slug)}}">{{$tag->title}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!--/ End Single Widget -->
                            ...
                            <div class="letter-inner">
                                ...
                                <form action="{{route('subscribe')}}" method="POST">
                                    ...
                                    <div class="form-inner">
                                        ...
                                        <button type="submit" class="btn mt-2">{{ trans('app.Submit') }}
                                    </div>
                                </form>
                            </div>
                        </div>
