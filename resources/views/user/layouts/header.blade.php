<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
  ...
  <input type="text" class="form-control bg-light border-0 small" placeholder="{{ __('user.search_placeholder') }}" aria-label="Search" aria-describedby="basic-addon2">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle" href="{{route('home')}}" target="_blank" data-toggle="tooltip" data-placement="bottom" title="{{ __('user.home_tooltip') }}"  role="button">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          ...
          <a class="dropdown-item" href="{{ route('logout') }}"
                onclick="event.preventDefault();
                 ...
                 <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> {{ __('user.modal.logout') }}
            </a>
